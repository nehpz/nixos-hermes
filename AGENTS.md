...
### Testing and Deployment Ladder

Right tool, right job. Pick the lightest tool that covers the change, but do not confuse build proof, smoke proof, and deployed proof.

| Change type | Tool | Root? | Proves |
|---|---|---|---|
